package com.aididi.Sender;

import com.aididi.entity.MailEntity;
import com.aididi.enums.MailSenderEnum;
import com.aididi.util.PropertiesUtil;
...
public class MailSender {
     ...
     * @return
     */
    public MailSender contentType(MailSenderEnum typeEnum)
    {
    ...
    public void send() throws Exception{
        ...
        if(mail.getContentType()== null){
            mail.setContentType(MailSenderEnum.HTML.getValue());
        }
        ...
        // 设置发送邮箱的16位STMP口令
        props.put("mail.password", propertiesUtil.getValue("mail.from.smtp.pwd"));
        ...
        //html发送邮件
        if(mail.getContentType().equals(MailSenderEnum.HTML.getValue())) {
            // 设置邮件的内容体
            message.setContent(mail.getContent(), mail.getContentType());
        }
        //文本发送邮件
        else if(mail.getContentType().equals(MailSenderEnum.TEXT.getValue())){
